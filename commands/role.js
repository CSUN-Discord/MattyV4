...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (roleChangeChannelId != null) {
            ...
            const roleChangeChannel = interaction.client.channels.cache.get(roleChangeChannelId);
            if (roleChangeChannel.type !== "GUILD_TEXT")
                return interaction.followUp("The role change channel ID needs to be a text channel.");
            ...
            await interaction.followUp("The role change channel ID needs to be set.")
        }
